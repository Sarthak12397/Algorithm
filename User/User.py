...
class page:
    def __init__(self,window):
        ...
        self.display = Button(R_frame, font=("Times New Roman", 16, 'bold'), text="display", bd=5, pady=2,
                                    padx=25, width=6, height=2, command=self.read_data).grid(row=6, column=0, padx=1)
        ...
        self.read = Button(R_frame, font=("Times New Roman", 16, 'bold'), text="read", bd=5, pady=2,
                                    padx=25, width=6, height=2, command=self.read).grid(row=9, column=0, padx=1)
